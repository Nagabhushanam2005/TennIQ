...
class CourtReference:
    ...
    def __init__(self):
        ...
        self.court = cv2.cvtColor(cv2.imread('/home/nagabhushanam/Repos/TennIQ/inference/src/court_configurations/court_reference.png'), cv2.COLOR_BGR2GRAY)
    ...
    def build_court_reference(self):
        ...
        plt.imsave('/home/nagabhushanam/Repos/TennIQ/inference/src/court_configurations/court_reference.png', court, cmap='gray')
        self.court = court
        return court
